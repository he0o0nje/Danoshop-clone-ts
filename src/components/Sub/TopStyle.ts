      ...
      tr {
        ...
        td {
          ...
          select {
            ...
            background: #fff
              url("https://he0o0nje.github.io/Danoshop-clone-ts/img/icon/ico_select.png")
    ...
    .npay_btn_box {
      ...
      .npay_btn {
        ...
        .npay_txt {
          ...
          width: 7.9rem;
          height: 3.6rem;
          background: url("https://he0o0nje.github.io/Danoshop-clone-ts/img/icon/npay_text.png")
            no-repeat;
        ...
        table {
          ...
          td {
            ...
            .npay_btn_pay {
              ...
              background-image: url("https://he0o0nje.github.io/Danoshop-clone-ts/img/icon/npay_pay.png");
              background-position: 50% 0;
              background-size: 6.3rem auto;
            }
            .npay_btn_zzim {
              background-image: url("https://he0o0nje.github.io/Danoshop-clone-ts/img/icon/npay_zzim.png");
              background-position: 50% 0;
      ...
      .npay_event {
        ...
        .npay_more {
          ...
          width: 1.6rem;
          height: 1.6rem;
          background: url("https://he0o0nje.github.io/Danoshop-clone-ts/img/icon/npay_more.png")
            no-repeat;
